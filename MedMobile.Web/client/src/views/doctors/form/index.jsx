...
const DoctorForm = () => {
    ...
    const departments = [{value: 1, label: "Пульмонология"}, {value: 2, label: "Неврология"}, {
        value: 3,
        label: "Repaint"
    }, {value: 4, label: "Педиатрия"}, {value: 5, label: "Гинекология"},];

    const cityRegion = [{value: 1, label: "Toshkent"}, {value: 2, label: "Jizzax"}, {
        value: 3,
        label: "Samarqand"
    }, {value: 4, label: "Buxoro"}, {value: 5, label: "Qashqadaryo"}, {value: 6, label: "Surxondaryo"}, {
        value: 7,
        label: "Navoiy"
    }, {value: 8, label: "Andijon"}, {value: 9, label: "Farg'ona"}, {value: 10, label: "Namangan"},];

    const districts = [{value: 1, label: "Uchtepa tumani"}, {value: 2, label: "Shayxontohur tumani"}, {
        value: 3,
        label: "Mirobod tumani"
    }, {value: 4, label: "Yashnobod tumani"}, {value: 5, label: "Mirzo Ulug'bek tumani"},];

    const specialization = [{value: 1, label: "Пульмонолог"}, {value: 2, label: "Невролог"}, {
        value: 3,
        label: "Терапевт"
    }, {value: 4, label: "Педиатр"}, {value: 5, label: "Гинеколог"},];
                        ...
                        <Row>
                            ...
                            <Col md="6" sm="12" className="mb-1">
                                ...
                                <Flatpickr
                                    ...
                                    options={{
                                        locale: Russian, allowInput: true, dateFormat: "d.m.Y", maxDate: "01.01.2000",
                                    }}
                                />
                            </Col>
                            <Col md="6" sm="12">
