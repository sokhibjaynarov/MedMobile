      ...
      <div className="auth-wrapper auth-cover">
        <Row className="auth-inner m-0">
          ...
          >
            ...
            <h2 className="brand-text text-primary ms-1">MedMobile</h2>
          </Link>
          <Col
          ...
          >
            <Col className="px-xl-2 mx-auto" sm="8" md="6" lg="12">
              ...
              <CardText className="mb-2">
                Elektron pochtangizni kiriting va biz sizga parolni tiklash
              ...
              <p className="text-center mt-2">
                <Link to="/login">
                  ...
                  <span className="align-middle">Loginga qaytish</span>
                </Link>
              </p>
            </Col>
          </Col>
